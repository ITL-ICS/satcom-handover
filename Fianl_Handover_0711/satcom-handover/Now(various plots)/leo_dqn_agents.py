...
class DQN_agent:
    def __init__(self, state_space, action_space, lr=5*1e-5, gamma = 0.9, epsilon_start = 1.0, epsilon_end = 0.1, epsilon_decay = 0.9995, sync_target_net_every = 100, n_episodes = 500, batch_size = 64):
